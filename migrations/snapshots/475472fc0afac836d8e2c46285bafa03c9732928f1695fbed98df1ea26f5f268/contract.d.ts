...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly Notification: {
      ...
      readonly queueId: CodecTypes['pg/text@1']['output'] | null;
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly Notification: {
      ...
      readonly channel: 'IN_APP' | 'EMAIL' | 'SMS' | 'PUSH';
      readonly queueId: CodecTypes['pg/text@1']['input'] | null;
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly notification: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [
                { readonly columns: readonly ['userId', 'type', 'eventId'] },
                { readonly columns: readonly ['userId', 'type', 'dedupeKey'] },
              ];
              indexes: readonly [
                {
                ...
                {
                  readonly name: 'notification_queueId_idx_88ef1f02';
                  readonly prefix: 'notification_queueId_idx';
                  readonly columns: readonly ['queueId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'notification_entryId_idx_8b42d1db';
                  readonly prefix: 'notification_entryId_idx';
                  readonly columns: readonly ['entryId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'notification_eventId_idx_6a266d47';
                  readonly prefix: 'notification_eventId_idx';
        ...
        readonly enum: {
          ...
          readonly NotificationType: {
            ...
            readonly members: readonly [
              ...
              { readonly name: 'PATIENT_CALLED'; readonly value: 'PATIENT_CALLED' },
              { readonly name: 'CONSULTATION_STARTED'; readonly value: 'CONSULTATION_STARTED' },
              { readonly name: 'QUEUE_COMPLETED'; readonly value: 'QUEUE_COMPLETED' },
